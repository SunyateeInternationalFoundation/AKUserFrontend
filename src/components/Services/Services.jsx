            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-baseline">
                  ...
                  <span className="text-sm text-gray-600 ml-2">/ {service.sessions} sessions</span>
                </div>
              </div>

              <div className="flex gap-2">
                <button className="flex-1 border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-50">Free Trail</button>
                <button className="flex-1 border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-50">Book Session</button>
              </div>
            </div>
          </div>
        ))}
